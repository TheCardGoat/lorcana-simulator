<script lang="ts">
  import ArchetypeMatchmakingLobby from '$lib/features/matchmaking/ui/ArchetypeMatchmakingLobby.svelte';
  ...
  const PAGE_TITLE = 'Lorcana Archetype Matchmaking';
  ...
  const showImmersiveStart = $derived(
    ready &&
      isMobile.current &&
      !immersiveExperience.hasStartedSession &&
      !immersiveExperience.isStandalone,
  );
...
<svelte:head>
  ...
  <meta
    name="description"
    content="Create and browse archetype-based matchmaking rooms."
  />
  <meta name="theme-color" content="#020617" />
</svelte:head>

<main
  class="immersive-app-shell simulator-dark min-h-screen min-h-dvh bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.16),transparent_28%),linear-gradient(180deg,#020617_0%,#020617_46%,#030712_100%)]"
>
