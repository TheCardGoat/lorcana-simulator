...
import { judyHoppsOptimisticOfficerI18n } from "./157-judy-hopps-optimistic-officer.i18n";
  ...
  text: [
    {
      ...
      description:
        "When you play this character, you may banish chosen item. If you do, its player draws a card.",
    },
  ],
