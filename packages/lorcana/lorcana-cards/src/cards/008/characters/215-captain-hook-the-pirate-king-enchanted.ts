...
import { captainHookThePirateKingEnchantedI18n } from "./215-captain-hook-the-pirate-king-enchanted.i18n";

export const captainHookThePirateKingEnchanted: CharacterCard = {
  id: "mT7",
  canonicalId: "ci_dkw",
  reprints: ["set8-109"],
  cardType: "character",
  ...
  i18n: captainHookThePirateKingEnchantedI18n,
};
