...
import { snugglyDucklingDisreputablePubEnchantedI18n } from "./216-snuggly-duckling-disreputable-pub-enchanted.i18n";
...
export const snugglyDucklingDisreputablePubEnchanted: LocationCard = {
  ...
  i18n: snugglyDucklingDisreputablePubEnchantedI18n,
};
