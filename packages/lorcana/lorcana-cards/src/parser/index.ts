 ...
 * @example Basic usage
 * ```typescript
 * import { parseAbilityText } from "@tcg/lorcana-engine/parser";
 *
 ...
 * ```typescript
 * import { parseAbilityTexts } from "@tcg/lorcana-engine/parser";
 *
 ...
 * ```typescript
 * import { parseAbilityTextMulti } from "@tcg/lorcana-engine/parser";
 *
