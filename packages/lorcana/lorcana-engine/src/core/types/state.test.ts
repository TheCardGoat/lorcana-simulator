...
import type { CardInstanceId, PlayerId, ZoneId } from "./index";
import type { IState, InternalState } from "./state";

/** Minimal zone config for tests (zones module removed) */
const zoneConfig = {
...
describe("InternalState", () => {
  it("should allow defining zones with configuration and card lists", () => {
    ...
    const internalState: InternalState<TestCardDef, TestCardMeta> = {
      ...
      zones: {
        hand: {
          cardIds: ["card-1", "card-2"] as unknown as CardInstanceId[],
          config: zoneConfig,
        },
      },
    };
      ...
      internal: {
        ...
        zones: {
          hand: {
            ...
            cardIds: ["card-1"] as unknown as CardInstanceId[],
          },
        },
      },
    };
