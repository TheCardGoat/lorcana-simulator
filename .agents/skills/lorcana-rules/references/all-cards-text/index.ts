...
async function extractAndAnalyzePatterns(): Promise<PatternAnalysis> {
  ...
  try {
    ...
    console.log(`   - Categories: ${Object.keys(analysis.categoryCounts).length}\n`);
...
async function generateReport(analysis: PatternAnalysis, outputDir: string): Promise<void> {
...
async function exportJSON(analysis: PatternAnalysis, outputDir: string): Promise<void> {
...
async function exportTypeScript(analysis: PatternAnalysis, outputDir: string): Promise<void> {
